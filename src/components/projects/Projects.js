    ...
    <section id='projects'>
      ...
      <div className='container projects__container'>
        ...
        <article className='projects__item'>
          ...
          <div className='projects__item-cta'>
            <a href='https://github.com/studentjsw/lg-fr.git' className='btn' target='_blank' rel="noreferrer">Frontend</a>
            <a href='https://github.com/studentjsw/lg-bck.git' className='btn' target='_blank' rel="noreferrer">Backend</a>
            <a href='https://frabjous-frangipane-e4af3d.netlify.app/' className='btn btn-primary' target='_blank' rel="noreferrer">Live Demo</a>
          </div>
        </article>
        <article className='projects__item'>
          <div className='projects__item-image'>
